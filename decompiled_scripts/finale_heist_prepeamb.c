...
void func_139()
{
	...
	func_146();
	func_111();
	if (func_78(unk_0xE2D3D51028F0428A(), Local_106, 150f, 1) && !unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, 0, 1, 0))
	{
...
void func_149()
{
	if (func_105(35))
	{
		if (iLocal_38 == 0)
		{
			...
			{
				if (!func_78(iLocal_109, Local_106, 10f, 1) || unk_0x68C47642183F091A(iLocal_109))
				{
					unk_0xB0550BC91B0159D6(&uLocal_105, true);
				}
			}
