...
void __EntryFunction__()
{
	...
	{
		unk_0x8386356641D0DED1(Local_83.f_28[0], uLocal_328);
		unk_0x598D91BBD045C1F3(Local_83.f_28[0], 132, 1);
	}
	while (true)
	{
	...
	switch (iLocal_145)
	{
		case 0:
			...
			if (unk_0x2BBF749E555360DC("rcmjosh1leadinout") && unk_0x0CBB7C273DED26E7(joaat("p_amb_phone_01")))
			{
				if (!unk_0x7DE17ACDD8BA2642(iLocal_147))
				{
					...
					iLocal_147 = unk_0x0744FA5607ECEB91(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 1, 0, 1);
				}
				iLocal_145 = 1;
			}
			break;
		...
		case 1:
			if (iLocal_158 == 1)
			{
				...
				if ((unk_0xA5E11AF0A2B928C1() - iLocal_159) >= 500)
				{
					func_235(1, 1, 1);
					iLocal_158 = 0;
				}
			...
			if (!iLocal_160)
			{
				if (func_297(Local_83.f_28[0]) && unk_0x7DE17ACDD8BA2642(iLocal_147))
				{
					uLocal_149 = unk_0x191673E3F99212B2(Local_150, Local_153, 2);
					unk_0x468D976993BF7FE1(Local_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
					unk_0xA2CBB04560DD6361(iLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
					unk_0x219B35BBE9DF373A(iLocal_147);
					unk_0xBB6027D1D193CBA6(Local_83.f_28[0], 1, 0);
			...
			else if (unk_0x411B750250543BD0(uLocal_149))
			{
				if (unk_0xABF98B1999FE64CA(uLocal_149) > 0.29f)
				{
					if (!iLocal_161)
					{
						func_234(&uLocal_163, 2, unk_0xC1A5EC5C986B98AD(), "Trevor", 0, 1);
				...
				if (unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, 0, 1, 0))
				{
					func_246("Too close, stopping scene");
					if (func_296(Local_83.f_28[0]))
					{
						unk_0x909F139DC199D8E0(Local_83.f_28[0]);
						func_246("Stopping Josh?");
					}
					if (unk_0x7DE17ACDD8BA2642(iLocal_147))
					{
						unk_0xFB58581C53CF4C05(iLocal_147, -8f, 1);
					}
					iLocal_162 = 1;
				}
				if (func_218(Local_83.f_28[0], unk_0xC1A5EC5C986B98AD(), 1) > 17.5f)
				{
					if (func_296(Local_83.f_28[0]))
					{
						unk_0xFB58581C53CF4C05(Local_83.f_28[0], -8f, 1);
						unk_0x909F139DC199D8E0(Local_83.f_28[0]);
					}
					if (unk_0x7DE17ACDD8BA2642(iLocal_147))
					{
				...
				if ((unk_0x66599E73DBA5A850(Local_83.f_28[0]) || unk_0x584CD220C093B0B4(Local_83.f_28[0])) || unk_0xD612176B6DC58EF7(-1, unk_0x30BE8A934C020461(Local_83.f_28[0], 1), 5f))
				{
					if (func_296(Local_83.f_28[0]))
					{
						unk_0xFB58581C53CF4C05(Local_83.f_28[0], -8f, 1);
		...
		case 2:
			...
			if (func_296(Local_83.f_28[0]))
			{
				...
				unk_0x3D7110D966B0CEA2(Local_83.f_28[0], uLocal_146);
				unk_0x63EF69C6969A3D26(&uLocal_146);
				unk_0xC5B2830898581862(Local_83.f_28[0], 0);
				if (iLocal_162 == 0)
				{
					unk_0xC5F9EF8F410596F9(Local_83.f_28[0], joaat("MotionState_Walk"), 0, 0, 1);
				}
			}
			if (unk_0x17AE936FF608BF89(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
...
int func_222()
{
	...
	if (unk_0x93E99A2DBCBA9CFA() == func_225())
	{
		return 0;
	}
...
void func_237(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam1 == 1)
	{
		...
		{
			if (func_296(unk_0xC1A5EC5C986B98AD()))
			{
...
void func_238(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if ((((((!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && !func_242(unk_0x93E99A2DBCBA9CFA())) && !func_240(unk_0x93E99A2DBCBA9CFA(), 0)) && !func_239()) && !bParam4) && !bParam5) && !unk_0x8253CEEA17ED481B())
			{
...
void func_247()
{
	...
	if (unk_0x3B7E6BE32C24780B())
	{
		...
		if (func_296(Local_83.f_28[0]))
		{
			unk_0x414C472A4880EAA3("Josh", Local_83.f_28[0], 0);
		}
	}
	switch (iLocal_145)
	{
		case 0:
			if (func_263(1, 1093140480, 0))
			{
				...
				if (func_296(Local_83.f_28[0]))
				{
					unk_0x970443E58680427C(Local_83.f_28[0], "Josh", 0, 0, 0);
				}
				if (func_296(unk_0xC1A5EC5C986B98AD()))
				{
					unk_0x970443E58680427C(unk_0xC1A5EC5C986B98AD(), "Trevor", 0, 0, 0);
				}
				unk_0x9D0EAD95433304CA(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, 0, 0, 1);
				unk_0x10DFA2EC4C030EB3(-1146.306f, 295.9831f, 66.13612f, 9f, 0, 0, 0, 0, 0, 0, 0);
				unk_0x10DFA2EC4C030EB3(-1143.244f, 280.2762f, 65.41892f, 12f, 0, 0, 0, 0, 0, 0, 0);
				unk_0x10DFA2EC4C030EB3(-1152.426f, 313.6157f, 67.10429f, 12f, 0, 0, 0, 0, 0, 0, 0);
				unk_0x10DFA2EC4C030EB3(-1165.966f, 332.6786f, 68.81f, 12f, 0, 0, 0, 0, 0, 0, 0);
				unk_0x10DFA2EC4C030EB3(-1178.729f, 346.4572f, 70.04675f, 12f, 0, 0, 0, 0, 0, 0, 0);
				unk_0x25578EAEB8729E15(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, 0, 0, 0, 0, 0, 0, 0);
				uVar0 = unk_0xE475C458F52F1781();
				if (func_262(uVar0))
				{
					if (unk_0x9DC9E896F189AAA5(uVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, 1, 0))
					{
		...
		case 1:
			...
			if (unk_0x42C63C7AA899C5C8("Josh", 0))
			{
				...
				if (!iLocal_160)
				{
					...
					func_248(unk_0xC1A5EC5C986B98AD(), -1104.65f, 289.02f, 63.25f, 16.6717f, 0, 1);
					unk_0xEAB390443C680F72(0f, 1065353216);
					unk_0xAABD7B0753C5C286(0f);
					if (func_297(Local_83.f_28[0]) && unk_0x7DE17ACDD8BA2642(iLocal_147))
					{
						uLocal_149 = unk_0x191673E3F99212B2(Local_150, Local_153, 2);
						unk_0x468D976993BF7FE1(Local_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						unk_0xA2CBB04560DD6361(iLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						func_246("Done Josh leadout anim on Josh exit state");
						unk_0x219B35BBE9DF373A(iLocal_147);
						unk_0xC5F9EF8F410596F9(Local_83.f_28[0], joaat("MotionState_Idle"), 0, 1, 1);
						iLocal_160 = 1;
					}
				}
			}
			...
			if (!unk_0x34641C4C8576592F())
			{
				...
				if (!iLocal_160)
				{
					...
					{
						uLocal_149 = unk_0x191673E3F99212B2(Local_150, Local_153, 2);
						unk_0x468D976993BF7FE1(Local_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						unk_0xA2CBB04560DD6361(iLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						func_246("Done Josh leadout anim on non active cutscene");
						unk_0x219B35BBE9DF373A(iLocal_147);
						unk_0xBB6027D1D193CBA6(Local_83.f_28[0], 0, 0);
						iLocal_160 = 1;
					}
				}
				iLocal_145 = 2;
...
void func_249(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x48DC6A21D1CAD89C(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x6FCA8E220FB1053D(func_250(unk_0x5DC3DCA82C806319()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_263(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
	{
		...
		{
			if (!func_269(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_271()
{
	...
	{
		case 0:
			if (!func_5(0) && unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, 1, 0))
			{
		...
		case 1:
			if (!func_5(0))
			{
				if (!bLocal_156)
				{
					if (unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, 1, 0))
					{
						if (func_297(Local_83.f_28[0]) && unk_0x7DE17ACDD8BA2642(iLocal_147))
						{
							uLocal_148 = unk_0x191673E3F99212B2(Local_150, Local_153, 2);
							unk_0x468D976993BF7FE1(Local_83.f_28[0], uLocal_148, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							unk_0xA2CBB04560DD6361(iLocal_147, uLocal_148, "leadin_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
							unk_0xEDB03CCB50D11479(unk_0xC1A5EC5C986B98AD(), Local_83.f_28[0], -1, 0, 2);
							unk_0xEDB03CCB50D11479(Local_83.f_28[0], unk_0xC1A5EC5C986B98AD(), 4000, 2060, 2);
				...
				else if (unk_0x411B750250543BD0(uLocal_148))
				{
					...
					if (func_218(unk_0xC1A5EC5C986B98AD(), Local_83.f_28[0], 1) <= 2.5f)
					{
...
void func_273()
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
		{
			if (func_269(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_291(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	switch (Global_78813)
	{
		...
		case 5:
			if ((unk_0x2FECE8D166B3056B() || func_278(0)) || func_292(1))
			{
			}
			else
			{
...
void func_326(bool bParam0)
{
	...
	if (!func_343())
	{
		...
		{
			func_161(iVar0, 1, 0);
			func_327(unk_0x688846D56810779A(), iVar0);
		}
		else
		{
			if (Global_112735[iVar0 /*10*/].f_9 == -1)
