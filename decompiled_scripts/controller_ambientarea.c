		...
		while (iVar1 != 2)
		{
			if (func_13(&(Global_32299[iVar0 /*7*/])))
			{
				if (func_12(iVar0, Var2))
				{
					...
					{
						if (unk_0x87C0DA419F19FF57(Global_32299[iVar0 /*7*/].f_5))
						{
							unk_0xD4798E4F64B31C25(Global_32299[iVar0 /*7*/].f_5, 1);
						}
...
{
	Param1.f_2 = 0f;
	if (!unk_0x87C0DA419F19FF57(Global_32299[iParam0 /*7*/].f_5))
	{
		return 1;
	}
