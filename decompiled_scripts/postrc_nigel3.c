...
void func_1()
{
	...
	{
		case 0:
			if ((unk_0xA5E11AF0A2B928C1() - iLocal_187) > 5000 && unk_0x7559C38E6535AB89(uLocal_188, unk_0xC1A5EC5C986B98AD(), 1))
			{
			...
			else if ((unk_0xA5E11AF0A2B928C1() - iLocal_187) > 12000 && unk_0xB7A628320EFF8E47(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), unk_0x30BE8A934C020461(uLocal_188, 1)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
{
	iLocal_187 = unk_0xA5E11AF0A2B928C1();
	func_21(&uLocal_22, 2, unk_0xC1A5EC5C986B98AD(), "TREVOR", 0, 1);
...
int func_22()
{
	...
	fVar0 = 200f;
	if (unk_0xB7A628320EFF8E47(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), unk_0x30BE8A934C020461(uLocal_188, 1)) >= (fVar0 * fVar0) && !unk_0x865259F0333CAA4B(uLocal_188))
	{
		return 0;
	}
	return 1;
...
int func_31()
{
	...
	{
		iVar17 = unk_0xA5D17FEE5372152E(unk_0xC1A5EC5C986B98AD(), &uVar0, -1);
		iVar18 = 0;
		while (iVar18 <= (iVar17 - 1))
		{
			if (uVar0[iVar18] != 0 && unk_0x7DE17ACDD8BA2642(uVar0[iVar18]))
			{
				if (unk_0x504B9BB48D41C264(uVar0[iVar18]) == joaat("u_m_m_aldinapoli"))
				{
					unk_0x85BAE84748AD1A23(uVar0[iVar18], 1, 1);
