...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_1931928)
		{
			if (!Global_1931930)
			{
				Global_1931927 = unk_0x528279F3F1EEF869("OPENING_CREDITS");
				Global_1931930 = 1;
			}
			else if (unk_0x0347CCBD719C8ADC(Global_1931927))
			{
				if (!Global_1931929)
				{
...
void func_57()
{
	...
	{
		if (func_60(Global_113386.f_2363.f_539.f_4321) != unk_0x15CAA6D7B11F1A7C(unk_0xE2D3D51028F0428A()))
		{
...
int func_165()
{
	...
	if (Global_2715699.f_6597 && Global_2725323)
	{
		if (func_170(0))
		{
			if (func_168() && !unk_0xA829C9A2767AC8EF())
			{
...
{
	if (func_180(unk_0x9E2D6C50374FCFA9()) && BitTest(Global_1946250.f_4, 22))
	{
		return 0;
	}
	if (Global_1577870)
...
var func_171()
{
	return func_172(unk_0x9E2D6C50374FCFA9());
}
...
int func_174(float fParam0)
{
	...
	Var0 = { func_175(unk_0x9E2D6C50374FCFA9()) };
	if (Var0.f_2 < fParam0)
	{
		if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
