	...
	while (iVar0 < 204)
	{
		if (!Global_58896[iVar0 /*7*/])
		{
			if (Global_58896[iVar0 /*7*/].f_2)
			{
				...
				{
					unk_0x61481F9FBB1C7EDD(Global_58896[iVar0 /*7*/].f_3, &(Global_58896[iVar0 /*7*/].f_5), -1);
				}
				else
				{
					fVar1 = 0f;
					unk_0x9A69A54179CEA8E5(Global_58896[iVar0 /*7*/].f_3, &fVar1, -1);
					Global_58896[iVar0 /*7*/].f_5 = unk_0xF34EE736CF047844(fVar1);
				}
			}
		}
		iVar0++;
...
void func_4()
{
	...
	if (!unk_0x20E4972CBF3DBE1B())
	{
		...
		{
			Global_60326 = 0;
			Global_60327 = unk_0x320D1840B6DAA1CC();
			Global_63139 = 1;
		}
		return;
	}
...
int func_5()
{
	...
	while (iVar0 < 80)
	{
		if (Global_55453[iVar0 /*36*/].f_8)
		{
			...
			{
				uVar2 = Global_58334[Global_55453[iVar0 /*36*/].f_35 /*7*/];
				unk_0x9A69A54179CEA8E5(uVar2, &(Global_55453[iVar0 /*36*/].f_9), -1);
				if (Global_55453[iVar0 /*36*/].f_9 > 0f)
				{
					fVar3 = 0f;
					unk_0xB4455B84F602B40D(uVar2, 0, &(Global_55453[iVar0 /*36*/].f_33));
...
void func_41()
{
	...
	while (iVar0 < 204)
	{
		if (!Global_58896[iVar0 /*7*/])
		{
			if (Global_58896[iVar0 /*7*/].f_2)
			{
				...
				if (!Global_58896[iVar0 /*7*/].f_4)
				{
					unk_0x61481F9FBB1C7EDD(Global_58896[iVar0 /*7*/].f_3, &iVar1, -1);
				}
				else
				{
					fVar2 = 0f;
					unk_0x9A69A54179CEA8E5(Global_58896[iVar0 /*7*/].f_3, &fVar2, -1);
	...
	while (iVar0 < 80)
	{
		if (!Global_55453[iVar0 /*36*/].f_8)
		{
			...
			fVar5 = (fVar5 + ((unk_0xC4EAB25A108C2429(-Global_58608[iVar4 /*7*/].f_6, Global_58608[iVar4 /*7*/].f_6) * 0.1f) * Global_55453[iVar0 /*36*/].f_9));
...
int func_61(int iParam0, var uParam1)
{
	...
	while (iVar0 < 68)
	{
		if (Global_77137.f_484[iVar0] == iParam0)
		{
			...
			{
				if (BitTest(Global_77137.f_555[0 /*21*/].f_9, 10) && Global_77137.f_555[0 /*21*/].f_4 == unk_0x15CAA6D7B11F1A7C(iParam0))
				{
					*uParam1 = iVar0;
					return 1;
				}
	...
	while (iVar0 < 80)
	{
		if (Global_55453[iVar0 /*36*/].f_8)
		{
			...
			if (iVar1 > -1)
			{
				...
				unk_0x076A5661EF5ABEE4(Global_58334[iVar1 /*7*/].f_3[iParam0], iVar2, 1);
			}
		}
		iVar0++;
	}
			...
			if ((Global_55453[iVar1 /*36*/].f_32 > 0f && Global_55453[iVar1 /*36*/].f_31 > 0f) && Global_55453[iVar1 /*36*/].f_9 > 0f)
			{
				...
				if (fVar16 != 1f)
				{
					...
					while (iVar3 <= 15)
					{
						...
						Global_55453[iVar1 /*36*/].f_14[iVar3] = (Global_55453[iVar1 /*36*/].f_14[iVar3] * (unk_0xC4EAB25A108C2429(0.95f, 1.05f) + (fVar18 * fVar17)));
						if (iVar3 == 15)
						{
...
void func_94()
{
	...
	if (!Global_113386.f_20564.f_101)
	{
		...
		while (iVar0 < 80)
		{
			if (!Global_55453[iVar0 /*36*/].f_8)
			{
				Global_55453[iVar0 /*36*/].f_9 = unk_0xC4EAB25A108C2429(15f, 290f);
			}
			iVar0++;
		}
		iVar0 = 0;
		...
		while (iVar1 <= 15)
		{
			...
			while (iVar0 < 80)
			{
				...
				Global_55453[iVar0 /*36*/].f_9 = (Global_55453[iVar0 /*36*/].f_9 * unk_0xC4EAB25A108C2429(fVar2, fVar3));
				Global_55453[iVar0 /*36*/].f_9 = func_93(func_92(unk_0x48053974ED6F63CE(Global_55453[iVar0 /*36*/].f_9), 3.5f), 290f);
				iVar0++;
			}
			iVar1++;
		}
...
void func_95()
{
	...
	iVar2 = unk_0x5853B15F78E1A265(0, (Global_60615 - 1));
	iVar0 = 0;
	while (iVar0 < 4)
	{
		iVar1 = 0;
