...
int func_78(int iParam0)
{
	if (iParam0 != func_80())
	{
		...
		else if ((Global_1575058 && iParam0 == unk_0x9E2D6C50374FCFA9()) && func_79(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
{
	if (unk_0x55A0C756C4A8220C(Global_112096.f_222[iParam0], 0))
	{
		unk_0x2D58A6131679D82C(Global_112096.f_222[iParam0], 1, 1);
