...
void func_17(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_19() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		unk_0xB0550BC91B0159D6(&(Global_113386.f_20564.f_471), bParam0);
		unk_0xB0550BC91B0159D6(&(Global_2359296[func_19() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
void func_61(int iParam0)
{
	if (iParam0 == 1)
	{
		unk_0xCED9E32812D6C7C7(&Global_8136, 24);
	}
	else
	{
...
int func_74(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	...
	unk_0xCED9E32812D6C7C7(&Global_8137, 9);
...
struct<4> func_104(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_109(&(Global_113386.f_19961), 8) && iParam1) && iParam0 != 4) && func_107(3) > 0) && unk_0xC4EAB25A108C2429(0, 1065353216) < 0.75f)
	{
		bVar4 = 8;
		*uParam3 = 4;
	}
...
{
	if (Global_96902 != 0 && (unk_0x320D1840B6DAA1CC() - Global_96902) < 1800000)
	{
		return 0;
	}
	unk_0x249A0D3C5714BCF4("SHRINK", 0);
	...
	func_121(uParam0, 0, unk_0xE2D3D51028F0428A(), "MICHAEL", 0, 1);
	func_121(uParam0, 1, 0, "FRIEDLANDER", 0, 1);
	Global_96902 = unk_0x320D1840B6DAA1CC();
	return 1;
}
